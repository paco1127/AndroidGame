...
public class game_impossible extends AppCompatActivity {
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.game_impossible);
        ...
        btnHint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rewardedAd != null) {
                    Activity activityContext = game_impossible.this;
                    ...
                    Toast.makeText(game_impossible.this, "ONLY 1 AD IN EACH GAME!", Toast.LENGTH_SHORT).show();
                }
            }
        });

        // set image
        images = new int[]{R.drawable.impossible_1, R.drawable.impossible_2, R.drawable.impossible_3, R.drawable.impossible_4,
                R.drawable.impossible_5, R.drawable.impossible_6, R.drawable.impossible_7, R.drawable.impossible_8};
        ...
        bg.playbg(game_impossible.this, R.raw.impo_bg);
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    if(firstImgInd == list.get(i)){
                        ...
                        MediaPlayer.create(game_impossible.this, R.raw.match_sound).start();
                        ...
                        MediaPlayer.create(game_impossible.this, R.raw.wrong).start();
                    }
    ...
    public void done(){
        bg.stop();
        bg.play(game_impossible.this, R.raw.win_sound);
        if (vibrator.hasVibrator()) {
...
//            long[] patternLetter = {0, 0, 300}; // Vibration pattern for a letter pause
    ...
    private String calculateScore(){
        double score;
        double basicScore = 400.0;
        double timePenalty = (timeElapsedSeconds-60)*2;
        double movePenalty = (move-20)*5;
